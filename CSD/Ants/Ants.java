...
public class Ants
{
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        case 1: t=new Terrain1(T,A,M,"1.- General monitor, 1 cond ."); break; // must be Terrain1
        case 2: t=new Terrain2(T,A,M,"2.- GMonitor, 1 cond/cell:"); break; // must be Terrain2
        case 3: t=new Terrain3(T,A,M,"3.- GMonitor, 1 cond/cell, no deadlock:"); // must be Terrain3
        }
